...
const CACHE_NAME='language-miner-v6.4.218-pocket-mobile-r44';
const BUILD_VERSION='6.4.218';
...
const APP_SHELL=[
 './mobile-pocket.js','./mobile-pocket.css','./pickaxe-finishes.js','./pickaxe-finishes.css','./pose-textures.js','./pose-wardrobe.js','./player-lesson-pose-v1.png',
