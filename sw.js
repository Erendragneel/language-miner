...
const CACHE_NAME='language-miner-v6.4.215-pickaxe-finishes-r41';
const BUILD_VERSION='6.4.215';
...
const APP_SHELL=[
 './pickaxe-finishes.js','./pickaxe-finishes.css','./pose-textures.js','./pose-wardrobe.js','./player-lesson-pose-v1.png',
