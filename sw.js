...
const CACHE_NAME='language-miner-v6.4.248-course-levels-r74';
const BUILD_VERSION='6.4.248';
...
const APP_SHELL=['./short-stories.js','./short-stories-data.js','./short-stories.css',
