...
const CACHE_NAME='language-miner-v6.4.253-question-recovery-r79';
const BUILD_VERSION='6.4.253';
...
const APP_SHELL=['./mine-golem-v1.png','./short-stories.js','./short-stories-data.js','./short-stories.css',
