...
const CACHE_NAME='language-miner-v6.4.214-free-original-wallpaper-r40';
const BUILD_VERSION='6.4.214';
...
const APP_SHELL=[
 './pose-textures.js','./pose-wardrobe.js','./player-lesson-pose-v1.png',
