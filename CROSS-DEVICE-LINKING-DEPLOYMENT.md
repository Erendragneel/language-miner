...
3. Open `supabase/migrations/202608240001_repair_cross_device_parent_teacher_linking.sql` from this release and paste its complete contents into the query.
...
4. On the learner's device, reopen or refresh the Parent/Teacher Center. Confirm that the pending request names the adult and offers **Approve** and **Decline**.
