...
(()=>{'use strict';
 ...
 function pickaxeLayer(src,key){if(!pickaxes[key])return '';return `<defs><clipPath id="pose-pickaxe"><path d="M348 17 L308 71 L266 142 L251 181 L271 193 L267 245 L238 253 L222 315 L208 433 L181 365 L182 283 L190 239 L173 230 L178 193 L204 171 L229 119 L284 57 Z"/></clipPath>${filter('pose-pickaxe-color',pickaxes[key],2.1)}</defs>${image(src,'clip-path="url(#pose-pickaxe)" filter="url(#pose-pickaxe-color)"')}`;}
 function markup(o){
